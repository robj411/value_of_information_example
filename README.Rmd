...
plot(x,dr_samples,frame=F,typ='l',xlab='PM2.5',ylab='Relative risk',lwd=2,lty=1,col=adjustcolor('navyblue', alpha.f = 0.5),ylim=c(1,2))
for(i in 2:20){
  ...
  lines(x,dr_samples,typ='l',lwd=2,lty=1,col=adjustcolor('navyblue', alpha.f = 0.5))
}
...
legend(col=cols,legend=c('Scenario 1','Scenario 2'),bty='n',x=15e3,y=2e-3,lwd=2)
